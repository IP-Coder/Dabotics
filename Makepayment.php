    ...
    <div class="container  form-container">
        <form>
            ...
            <div class="mb-3">
                ...
                <input type="name" id="name" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Contact No</label>
                <input type="tel" id="con" required class="form-control" id="exampleInputPassword1">
            </div>

            <input disabled id="submit-btn" type="Continue" style="color: white;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
        </form>
    </div>
    <script>
        const nameInput = document.getElementById('name');
        const emailInput = document.getElementById('con');
